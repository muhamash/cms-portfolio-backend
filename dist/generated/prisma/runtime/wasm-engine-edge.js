...
function Fs(...t) { return t.join("/"); }
function Us(...t) { return t.join("/"); }
function Ns(t) { let e = jn(t), r = $n(t), [n, i] = e.split("."); return { root: "/", dir: r, base: e, ext: i, name: n }; }
function jn(t) { let e = t.split("/"); return e[e.length - 1]; }
function $n(t) { return t.split("/").slice(0, -1).join("/"); }
function Bs(t) { let e = t.split("/").filter(i => i !== "" && i !== "."), r = []; for (let i of e)
    i === ".." ? r.pop() : r.push(i); let n = r.join("/"); return t.startsWith("/") ? "/" + n : n; }
var Qn, qs, Vs, js, Ut, Jn = ie(() => {
    "use strict";
    u();
    c();
    m();
