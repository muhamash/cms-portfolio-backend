...
function vl(...e) { return e.join("/"); }
function Tl(e) { let t = Wi(e), r = Hi(e), [n, i] = t.split("."); return { root: "/", dir: r, base: t, ext: i, name: n }; }
function Wi(e) { let t = e.split("/"); return t[t.length - 1]; }
function Hi(e) { return e.split("/").slice(0, -1).join("/"); }
function Rl(e) { let t = e.split("/").filter(i => i !== "" && i !== "."), r = []; for (let i of t)
    i === ".." ? r.pop() : r.push(i); let n = r.join("/"); return e.startsWith("/") ? "/" + n : n; }
var zi, Al, Cl, Sl, dr, Yi = fe(() => {
    "use strict";
    f();
    u();
    c();
